...
public class BadCartTut22 : FightCart {
	...
	var wish = (GameObject) Instantiate(Resources.Load("prefab/" + itemList2[3]), transform.position + offsetVector[0], transform.rotation) ;	
	wish.tag = "wish";
	...
	wish = (GameObject) Instantiate(Resources.Load("prefab/" + itemList2[1]), transform.position + offsetVector[2], transform.rotation) ;	
	wish.tag = "wish";
	wish.transform.parent = transform;
	wishList[2] = wish;	
